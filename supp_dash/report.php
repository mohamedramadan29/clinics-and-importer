...
$stmt->execute(array($_SESSION['supp_id'], "Add New Order"));
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="main.php?dir=supp_dash&page=order_details&from=<?php echo $order['order_date_from']; ?>&to=<?php echo $order['order_date_to']; ?>&sup_id=<?php echo $order['pres_id']; ?>&emp_id=<?php echo $order['emp_id']; ?>" class="btn btn-warning btn-sm"> View Details <i class='fa fa-eye'></i> </a>
